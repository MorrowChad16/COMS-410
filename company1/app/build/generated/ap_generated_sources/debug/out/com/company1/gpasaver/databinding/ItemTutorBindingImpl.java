...
public class ItemTutorBindingImpl extends ItemTutorBinding  {
    ...
    public ItemTutorBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ItemTutorBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.classTut.setTag(null);
        this.gpaVal.setTag(null);
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.classTut, userViewModelPhoneNumber);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.gpaVal, userViewModelPhoneNumber);
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.rate, userViewModelPhoneNumber);
        }
    }
